...
st.header("🎴 Sonic Identity Profile")

combo_playlist = st.selectbox("Select a playlist for full identity breakdown", df['Playlist'].unique(), key="combo_profile")
...
# ─🎴 Display Everything
st.subheader(f"🎴 Sonic Identity of '{combo_playlist}'")
st.markdown(f"""
**☀️ Sun Sign (Genre):** {top_genre}  
**🌙 Moon Sign (Mood):** {moon}  
**🌅 Rising Sign (Decade):** {rising}  
**🔮 Zodiac:** {zodiac}

---

**🎭 Personality Profile:**  
Born around **{year}**, this playlist is a {top_genre.lower()} soul with a {vibe}  
Socially, it {social}  
Hobbies? It {hobby}
""")
